Public Class Form_About
    ...
    Private Sub Label_www_freetw_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) 
        Process.Start("http://www.theremino.com")
    End Sub

    Private Sub Label_InfoFreeTW_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) 
    ...
    Private Sub Labels_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) 
        Dim lb As Label = DirectCast(sender, Label)
        lb.BackColor = Color.FromArgb(250, 240, 255)
    End Sub

    Private Sub Labels_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) 
        Dim lb As Label = DirectCast(sender, Label)
