...
Partial Class DropdownColorBlender
    ...
    Friend WithEvents txbCurrColor As MyTextBox
    ...
    Friend WithEvents ColorBox As MyComboBox
    ...
    Friend WithEvents txbAlpha As MyTextBox
